...
public final class PKCoderUtil {
    // 定义 加密算法,可用 DES,DESede(TripleDES),Blowfish
    ...
    public static final String decodeString(String encodedHex, byte[] skey) {
        ...
        try {
            ...
            log.error(encodedHex + ":" + e.getClass().getName());
            return null;
        }
    }
    ...
    public static final String encryptString(String original, String key) {
        ...
        try {
            ...
            log.error(original + ":" + key + ":" + e.getClass().getCanonicalName());
        }
        return null;
    }
    ...
    public static final String decryptString(String encryptStr, String key) {
        ...
        try {
            ...
            log.error(encryptStr + ":" + e.getClass().getCanonicalName());
            return "";
        }
    }
    ...
    public static String TriDesEncrypt(String pKey, String pIV, String pContent) {
        ...
        try {
            ...
            ret = Base64.getEncoder().encodeToString(cipher.doFinal(pContent.getBytes("utf-8")));
    ...
    public static String RSAEncrypt(String pKey, String pContent) {
        ...
        try {
            ...
            byte[] b = Base64.getDecoder().decode(pKey.substring(startIndex, endIndex));
            ...
            b = Base64.getDecoder().decode(pKey.substring(startIndex, endIndex));
    ...
    public static String encryptWithThiDES(String keyStr, String plainText, String encoding) {
        try {
            ...
            return Base64.getEncoder().encodeToString(result).replaceAll("\r\n", "");
        } catch (Exception e) {
            log.error("", e);
        }
        return null;
    ...
    public static String decryptWithThiDES(String keyStr, String encrypt, String encoding) {
        try {
            byte[] key = Base64.getDecoder().decode(keyStr);
            byte[] src = Base64.getDecoder().decode(encrypt);
    ...
    public static String getRandomKey(int length) {
        ...
        for (int i = 0; i < length; i++) {
            key[i] = (byte) (RandomUtils.randomInt(i) & 0xff);
        }
