...
//		//log.warn(getNodeText(document, "/bookstore/book[1]"));
//		//log.warn(getNodeText(document, "/bookstore/book[1]/price"));
//		//log.warn(getNodeText(document, "/bookstore/book[2]/title/@lang"));
//		//log.warn(getNodeText(document, "/bookstore/book[2]/description"));
//		//log.warn("xx"+getNodeText(document, "/bookstore/book[1]/price22"));
//		//printNode(document, "//*");//所有Element节点
//		//printNode(document, "//node()");//所有节点
//		//printNode(document, "//title | //price");//所有节点
//		//log.warngetNodeTextList(document, "/bookstore/book/price", true));
