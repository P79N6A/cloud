...
public class JsonUtils {
    public static TJsonModule.UpperCasePropertyNamingStrategy UPPER_CASE_PROPERTY_NAMING_STRATEGY = new TJsonModule.UpperCasePropertyNamingStrategy();
    ...
    public static <T> T readJsonToObject(Class<T> clazz, String json) {
        ...
        try {
            ...
            log.error(StringUtils.substring(json, 0, 500), e, 15);
        }
        return null;
    }
    ...
    public static <T> T readJsonToObject(TypeReference<T> type, String json) {
        ...
        try {
            ...
            log.error("json:" + StringUtils.substring(json, 0, 500) + "\n", e);
        }
        return null;
    }
